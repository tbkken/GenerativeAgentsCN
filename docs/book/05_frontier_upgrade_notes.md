# 2023-2026 前沿演进与 GenerativeAgentsCN 升级路线 v0.1
...
> 2023 年 Generative Agents 之后，业界和学界在智能体方向有哪些更先进的理念？这些理念如何基于 GenerativeAgentsCN 做成可讲、可跑、可评价的升级实验？
...
GenerativeAgentsCN 当前 planning 主要围绕一天日程和当前计划拆解。
...
GenerativeAgentsCN 的当前优势是前者，升级方向是补上后者。
...
这一章要明确：本书不追求把 GenerativeAgentsCN 直接改成万级 Agent 平台，而是教读者用严谨实验方法从小规模仿真走向可分析仿真。
...
| 前沿方向 | 前四部分基础 | 第五部分升级 |
|---|---|---|
| 长期记忆 | 第 15 章记忆 | 第 29 章记忆治理 |
| 反思学习 | 第 18 章反思 | 第 30 章经验学习 |
| 目标规划 | 第 16 章日程 | 第 31 章目标驱动 |
| 多智能体协作 | 第 17 章社交 | 第 32 章组织化协作 |
| 社会仿真 | 第 21-22 章传播实验 | 第 33 章统计仿真 |
| 可信评价 | 第 26 章评价框架 | 第 34 章可复现指标 |
| 中文模型 | 第 19、25 章模型适配 | 第 35 章模式切换与成本优化 |
...
6. 用更严谨的指标评价智能体系统。
7. 基于 GenerativeAgentsCN 设计渐进式升级路线。
