...
from generative_agents.ga_studio.resources.map_document import MaterialSource
from generative_agents.ga_protocol.schemas.world import PixelRect
from generative_agents.ga_protocol.schemas.world import RecipeEntry
from generative_agents.ga_protocol.schemas.world import RenderRecipe
from generative_agents.ga_protocol.schemas.world import VisualLayer


VILLAGE_ROOT = (
    Path(__file__).resolve().parents[1] / "bundled" / "maps" / "village"
)
