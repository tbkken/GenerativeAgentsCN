"""Versioned kernel constants; cognitive behavior belongs to Skills."""
...
class AlgorithmProfile:
    ...
    def as_dict(self) -> dict[str, int]:
        ...
        """
        return asdict(self)
GA_CN_V1 = AlgorithmProfile(path_target_sample_limit=4, movement_tiles_per_minute=4, default_event_poignancy=1)
ALGORITHM_PROFILES: Mapping[str, AlgorithmProfile] = MappingProxyType({'ga-cn-v1': GA_CN_V1})
