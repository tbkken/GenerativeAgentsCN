...
from generative_agents.ga_protocol.schemas.spatial_assets import SpatialAppearance
from generative_agents.ga_protocol.schemas.spatial_assets import StableKey
