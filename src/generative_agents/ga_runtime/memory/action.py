...
from generative_agents.ga_runtime.engine.formatting import dump_dict
from generative_agents.ga_runtime.engine.time import to_date
...
class Action:
    ...
    def __str__(self):
        ...
        返回:
            返回函数计算得到的结果。
        """
        return dump_dict(self.abstract())
